...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'hello_3d_world.data';
      var REMOTE_PACKAGE_BASE = 'hello_3d_world.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_hello_3d_world.data');

      };
      Module['addRunDependency']('datafile_hello_3d_world.data');
    ...
    loadPackage({"files": [{"filename": "/earth-water.png", "start": 0, "end": 117691}], "remote_package_size": 117691, "package_uuid": "1ebc9d19-7b77-4312-849b-e6fdd9cda354"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'hello_3d_world.wasm';
